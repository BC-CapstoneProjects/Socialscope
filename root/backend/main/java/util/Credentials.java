...
public class Credentials {
	...
	private static final String DEFAULT_CREDENTIALS_FILE = "/Users/titie/eclipse-workspace/Capstone481project/src/main/java/private/credentials.json";
	...
	private void writeCredentialsToFile(String fp) {
		...
		try {
			...
			jo.put("youtubeUserAgent", youtubeUserAgent);
			jo.put("youtubeApiKey", youtubeApiKey);
